...
class DivXBackward0(ExtendedAutogradFunction):
    ...
    def _differentiation(
        ...
        flat_m2: Tensor = broadcasted_m2.flatten()
        ...
        flat_m1: Tensor = broadcasted_m1.flatten()
        for order in range(1, self._order + 1):
            derivative = flat_m1 * log_derivate(tensor=flat_m2, n=(order + 1))
            derivatives.append(derivative)
